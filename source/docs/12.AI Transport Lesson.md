# 9. AI Transport Lesson

## 1. Transport Bracket Assembly
...
The source code of the program is located in: [/home/pi/spiderpi/extend/self_transport.py]()

**2.5.1 Transportation Color and Preset Position Parameter**
...
**2.5.2 Start Detecting Transportation Object**
...
The source code of the program is located in: [/home/pi/spiderpi/extend/transport_cleaning.py]()

**3.5.1 Detect Red Line Parameter**
...
**3.5.2 Start Detecting Blue and Green Sponge Blocks**
...
**3.5.3 Start Transporting Sponge Block**
...
The source code of the program is located in:[/home/pi/spiderpi/extend/apriltag_follow.py]()

**4.4.1 Tag Detection Parameter**
...
**4.4.2 Execute Action Parameter**
