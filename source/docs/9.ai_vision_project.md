...
:::{Note}
The default color is black. If you want to change to white or red, please refer to [5.4.1 Modify Default Tracking Color]().
:::
...
(7) Set the default tracking color as black according to the [5.4.1Modify Default Tracking Color]() in below text.
