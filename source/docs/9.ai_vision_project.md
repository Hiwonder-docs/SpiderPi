...
* If color recognition is inaccurate, refer to the section "**[5.1.5 Function Extensions -> Adjusting Color Thresholds](#anchor_5_1_5)**" in this document to adjust the color threshold settings.
:::

### 5.1.4 Program Analysis

The source code of this program is saved in: [/home/pi/SpiderPi/function/color_recognition.py](https://store.hiwonder.com.cn/docs/spiderpi/source_code/color_recognition.zip)
...
:::{Note}
The default color is red. If you want to change to blue or green, please refer to "**[5.2.5 Modify Default Recognition Color](#anchor_5_2_5)**".
:::
...
<img class="common_img" src="../_static/media/9/2.1/1.gif"  />

### 5.2.4 Program Analysis

The source code of the program is located in：[/home/pi/spiderpi/functions/color_detect.py](https://store.hiwonder.com.cn/docs/spiderpi/source_code/color_detect.zip)
...
<img class="common_img" src="../_static/media/9/2.1/image14.png" style="width:840px"/>
...
(7) The default recognized color can be set as red according to the "[5.2.5 Function Extension ->Modify Default Recognition Color](#anchor_5_2_5)" in this text.
...
* If color recognition is inaccurate, refer to the section [5.3.5 Function Extension->Adjusting Color Threshold](#anchor_3_5_1) in this document to adjust the color threshold settings.

:::

### 5.3.4 Promgram Analysis

The source code for this program is located at：[/home/pi/spiderpi/functions/color_position_recognition.py](https://store.hiwonder.com.cn/docs/spiderpi/source_code/color_position_recognition.zip)
...
<img class="common_img" src="../_static/media/9/3.1/image31.png"  style="width:640px" />

(10) Find the code shown below.

<img class="common_img" src="../_static/media/9/3.1/image36.png" style="width:640px" />
...
<img class="common_img" src="../_static/media/9/4.1/1.gif"  />

### 5.4.4 Program Analysis

The source code of the program is located in：[/home/pi/spiderpi/functions/color_track.py](https://store.hiwonder.com.cn/docs/spiderpi/source_code/color_track.zip)
...
<img class="common_img" src="../_static/media/9/4.1/image24.png"  style="width:880px;"/>
...
(7) The default tracking color can be set as green according to the "[**5.4.5Modify Default Recognition Color**](#anchor_5_4_5)" in this text.
...
:::{Note}
The default color is black. If you want to change to white or red, please refer to [5.5.5 Function Extension ->Modify Default Tracking Color](#anchor_5_5_5).
:::

Lay the black tape and then place the robot on the line. SpiderPi will move along the black track.

<img class="common_img" src="../_static/media/9/5.1/1.gif"  />

### 5.5.4 Program Analysis

The source code of the program is located in：[/home/pi/spiderpi/functions/visual_patrol.py](https://store.hiwonder.com.cn/docs/spiderpi/source_code/visual_patrol.zip)
...
<img class="common_img" src="../_static/media/9/5.1/image23.png" style="width:840px"/>
...
(7) Set the default tracking color as black according to the [**5.5.5Modify Default Tracking Color**](#anchor_5_5_5) in below text.
...
The source code of the program is located in：[/home/pi/spiderpi/functions/apriltag_recognition.py](https://store.hiwonder.com.cn/docs/spiderpi/source_code/apriltag_recognition.zip)
...
<img class="common_img" src="../_static/media/9/7.1/1.gif"  />
...
The source code of the program is located in：[/home/pi/spiderpi/functions/apriltag_detect.py](https://store.hiwonder.com.cn/docs/spiderpi/source_code/apriltag_detect.zip)
...
The source code of the program is located in：[/home/pi/spiderpi/functions/face_recongition.py](https://store.hiwonder.com.cn/docs/spiderpi/source_code/face_recongnition.zip)
...
<img class="common_img" src="../_static/media/9/9.1/1.gif"  />

### 5.9.4 Function Extension

* **Modify Feedback Action** 

The built-in file is located in : [/home/pi/SpiderPi/ActionGroups](https://store.hiwonder.com.cn/docs/spiderpi/source_code/ActionGroups.zip).
...
The source code of the program is located in：[/home/pi/spiderpi/functions/face_detect.py](https://store.hiwonder.com.cn/docs/spiderpi/source_code/face_detect.zip)
...
### 5.10.4 Function Extension

* **Modify the Measured Value** 
...
The source code of the program is located in：[/home/pi/spiderpi/functions/avoidance.py](https://store.hiwonder.com.cn/docs/spiderpi/source_code/avoidance.zip)
